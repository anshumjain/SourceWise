  ...
  return (
    <footer className="mt-auto border-t border-stone-200 bg-white dark:border-stone-800 dark:bg-stone-950">
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-md text-sm leading-relaxed text-stone-600 dark:text-stone-300">
              Factual reporting only. Community votes reflect reader sentiment,
        ...
        {/* Hidden ad slot reserve — no visible placeholder in MVP */}
        <div className="hidden min-h-[90px]" aria-hidden="true" data-ad-slot="footer-banner" />
      </div>
    </footer>
  );
}
