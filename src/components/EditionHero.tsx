...
export function EditionHero({ formattedDate, articleCount }: EditionHeroProps) {
  return (
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-12">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-lg leading-relaxed text-stone-600 dark:text-stone-300">
            Facts only — who, what, when, where. You judge what it means for
            India through your vote on every story.
          </p>
