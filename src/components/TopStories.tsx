          ...
          return (
            ...
            >
              ...
              <Link
                ...
                className="font-serif text-base font-semibold leading-snug text-stone-900 hover:text-emerald-800 dark:text-stone-50 dark:hover:text-emerald-300"
              >
                {article.headline}
              </Link>
              ...
              <p className="mt-2 text-xs text-stone-500 dark:text-stone-400">
                {goodPercent}% rated good for the country
              </p>
            </li>
          );
        })}
